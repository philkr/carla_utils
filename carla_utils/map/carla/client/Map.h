...
namespace client {
  ...
  class Map
    : public std::enable_shared_from_this<Map>,
      private NonCopyable {
  public:
    explicit Map(const std::string & name, const std::string & xodr_content);
  ...
  private:
    ...
    const std::string name_, xodr_content_;
